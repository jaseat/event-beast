  ...
  render() {
    ...
    if (this.props.loaded && this.props.activeMarker !== null) {
      ...
      newLatLng = new google.maps.LatLng(
        this.props.markers[this.props.activeMarker].lat,
        this.props.markers[this.props.activeMarker].lng
      );
    }
    return (
      <Map
      ...
      >
        ...
        <InfoWindow position={newLatLng} visible={this.props.showingInfoWindow}>
          <div>
