      ...
      <div style={styleContainer}>
        ...
        <MuiThemeProvider muiTheme={getMuiTheme(BeastTheme)}>
          <Paper zDepth={4} style={stylePaper}>
            <img
              src={require('../img/LogoOne.png')}
              alt=""
              style={{ height: 275, display: 'inline', float: 'left' }}
            />
            <div style={{ marginLeft: 30, color: ' #FBC02D' }}>Event Beast</div>
            <div style={{ fontSize: 40, color: ' #FBC02D', marginLeft: 30 }}>
              Your guide through concrete jungle of the city
            </div>
          </Paper>
        </MuiThemeProvider>
